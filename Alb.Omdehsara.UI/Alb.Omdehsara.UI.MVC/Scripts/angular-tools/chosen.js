    ...
    return {
      ...
      link: function(scope, element, attr, ngModel) {
        ...
        disableWithMessage = function() {
          empty = true;
         // return element.attr('data-placeholder', chosen.results_none_found).attr('disabled', true).trigger('liszt:updated');
          return element.attr('data-placeholder', chosen.results_none_found).trigger('liszt:updated');
        };
        if (ngModel) {
