...
//http://blog.yodersolutions.com/validate-and-format-numbers-in-angularjs/
(function() {
  var fcsaNumberModule,
    __hasProp = {}.hasOwnProperty;

  fcsaNumberModule = angular.module('number', []);

  fcsaNumberModule.directive('number', [
    'numberConfig', function(fcsaNumberConfig) {
  ...
  fcsaNumberModule.provider('numberConfig', function() {
    var _defaultOptions;
    _defaultOptions = {};
